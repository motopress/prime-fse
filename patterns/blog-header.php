...
<div class="wp-block-group alignfull" style="border-bottom-color:var(--wp--preset--color--color-7);border-bottom-width:1px;margin-top:0;margin-bottom:90px;padding-top:60px;padding-right:var(--wp--preset--spacing--normal);padding-bottom:60px;padding-left:var(--wp--preset--spacing--normal)"><!-- wp:heading {"textAlign":"center","level":1} -->
